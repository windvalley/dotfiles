...
Core stack: Ghostty (terminal) + Zellij (multiplexer) + Fish (shell) + Helix (editor) + Mise (version manager) + AIChat (AI geek assistant), with a unified visual and interaction style across the entire stack.
